...
const HotelReg = () => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      console.log("POST /hotels response:", data); // ✅ Add this log
        ...
        <div className="relative flex flex-col items-center md:w-1/2 p-8 md:p-10">
          ...
          <div className="w-full mt-4">
            ...
            <input
              ...
              className="w-full border border-gray-300 mt-2 px-4 py-2 rounded-md outline-indigo-500 focus:border-black"
            />
          </div>
          ...
          <div className="w-full mt-4">
            ...
            <input
              ...
              required
              placeholder="Type here"
              className="w-full border border-gray-300 mt-2 px-4 py-2 rounded-md outline-indigo-500 font-light"
            />
          </div>
